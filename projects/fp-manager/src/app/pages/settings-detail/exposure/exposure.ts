...
import {
  ...
  shootingModeOptions,
  standardApertureOptions,
  standardShutterSpeedOptions,
...
export class ExposureSettingsComponent {
  ...
  protected readonly apertureOptions = standardApertureOptions;
  protected readonly shutterSpeedOptions = standardShutterSpeedOptions;
}
